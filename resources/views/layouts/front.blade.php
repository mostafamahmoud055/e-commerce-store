                            ...
                            @auth('web')
                                <div class="user">
                                    ...
                                    <a class="text-white" href="{{ route('profile.edit') }}">
                                        {{ ucfirst(Auth::user()->first_name).' '.ucfirst(Auth::user()->last_name) }}</a>
                                </div>
                                <ul class="user-login">
                                    <li>
                                        <a onclick="document.getElementById('logout').submit()">Sign Out</a>
                                    </li>
                                </ul>
                            @endauth
                            @auth('admin')
                                <div class="user">
                                    <i class="lni lni-user"></i>
                                    Admin ({{ (ucwords(Auth::guard('admin')->user()->name)) }})
                                ...
                                <ul class="user-login">
                                    ...
                                    <li>
                                        <a class="text-white" href="{{ route('dashboard.dashboard') }}">Dashboard</a>
                                    </li>
                                </ul>
                            @endauth
                            @guest
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-2 col-5">
                        <div class="middle-right-area">
                            ...
                            <div class="navbar-cart"style="gap:10px" >
                    ...
                    <form class="card login-form" method="post">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                ...
                                <a class="lost-pass"
                                    href="https://demo.graygrids.com/themes/shopgrids/account-password-recovery.html">Forgot
                                    password?</a>
                            </div>
                            <div class="button">
                            ...
                            <p class="outer-link">Don't have an account? <a
                                    href="https://demo.graygrids.com/themes/shopgrids/register.html">Register here </a>
                            </p>
                        </div>
                    </form>
                </div>
